...
public class mailPageTest extends TestBase {
    public mailPageTest() throws IOException {
    super();
    }
    HomePage homePage;
    ...
    public Object[][] testData() throws IOException {
        ...
        return testUtils.getDataFromExcel("sheet2");
    }
    @BeforeMethod
    ...
    public void sendmail(String email ,String pass ,String reciver) throws IOException, InterruptedException {
        mailpage=new mailPage();
        signinpage = new signinPage();
        signinpage.enteremail(email);
        Thread.sleep(3000);
        signinpage.enterpass(pass);
        mailpage.sendmessage(reciver);
    }
